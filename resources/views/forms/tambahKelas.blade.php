                ...
                <div class="row">
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_kelas" name="nama_kelas" placeholder="Masukan Nama Kelas...">
                  </div>
                    </div>
                  <div class="col-md-6">
                  <div class="form-group">
                    <label for="kompotensi_keahlian">kompotensi_keahlian</label>
                    <input type="text" class="form-control" id="kompotensi_keahlian" name="kompotensi_keahlian" placeholder="masukan nama kompotensi_keahlian">
                  </div>
                 </div>
                 </div>
                <!-- /.card-body -->
